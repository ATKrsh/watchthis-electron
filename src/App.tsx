...
export const AppContent: React.FC = () => {
  ...
  return (
    <div 
      ...
      onDrop={handleDrop}
      className={`relative flex flex-col h-screen w-screen bg-background text-slate-100 overflow-hidden font-sans select-none transition-all duration-300 ${
        neonBorder 
          ? 'border-[1.5px] border-[#00f0ff] shadow-[inset_0_0_15px_rgba(0,240,255,0.35),0_0_20px_rgba(0,240,255,0.55)]' 
          : ''
      } ${
        neonShadow 
          ? 'shadow-[0_0_80px_25px_rgba(0,240,255,0.25),0_0_150px_50px_rgba(59,130,246,0.2),0_0_220px_80px_rgba(139,92,246,0.15)]' 
          : ''
      }`}
    >
      {/* Ambient Neon Cloud Glow Overlay */}
      {neonShadow && (
        <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden opacity-60 transition-opacity duration-500">
          <div className="absolute -top-[20%] left-1/4 w-[600px] h-[350px] bg-cyan-500/20 rounded-full blur-[120px] animate-pulse" />
          <div className="absolute -bottom-[20%] right-1/4 w-[700px] h-[400px] bg-blue-600/15 rounded-full blur-[140px]" />
          <div className="absolute top-1/2 -left-[10%] w-[450px] h-[450px] bg-sky-400/10 rounded-full blur-[100px]" />
        </div>
      )}
                  ...
                  <div className="space-y-7 pb-12">
                    ...
                    {navFolderVideos.length > 0 && (
                      <div>
                        <div className="flex items-center gap-2 mb-3.5 px-1">
                          <span className="text-xs font-mono uppercase tracking-wider text-slate-300 font-semibold">
                            Media Files ({navFolderVideos.length})
                          </span>
                        </div>
                        <div
                          style={{
